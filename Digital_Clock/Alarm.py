...
def alarm():
    ...
    if AlarmT == CurrentTime:
        pg.mixer.music.load("Digital_Clock/GUITAR.WAV")
        pg.mixer.music.play()
...
img = ImageTk.PhotoImage(Image.open("Digital-Alarm-Clock-main/al.png"))
...
Button(root,text="STOP",font="Times 18 bold",command=stop).place(x=100,y=360)

Label(root,text="Click STOP Button To Stop Alarm",font="Times 14 ").place(x=80,y=420)
